  ...
  return (
    <Navbar isBordered isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} maxWidth='full' height={"6vh"} className='bg-[#141312]'>
      ...
      <NavbarContent justify = "end">
        <NavbarItem>
          <button onClick = {logout} className="flex h-[4vh] w-full grow items-center justify-center gap-2 rounded-md p-3 text-sm text-white font-medium hover:text-blue-600 md:p-2 md:px-3">
